...
void main(){gl_Position=position;}`;
    ...
    class PointerHandler {
        ...
        constructor(element: HTMLCanvasElement, scale: number) {
            ...
            element.addEventListener('pointerdown', (e) => {
                ...
                this.first = this.pointers.values().next().value || this.lastCoords;
            });
    ...
    const loop = (now: number) => {
        ...
        rendererRef.current.updateMouse(pointersRef.current.firstCoords);
...
const AnimatedShaderHero: React.FC<HeroProps> = ({
    ...
    return (
        <div className={`relative w-full h-screen min-h-screen overflow-hidden bg-black ${className}`}>
            <canvas
                ref={canvasRef}
